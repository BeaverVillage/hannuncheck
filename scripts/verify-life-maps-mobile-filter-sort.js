...
for (const feature of features) {
  ...
  assert(html.includes(version), `${feature.name}: v124-life-maps-final-ui-qa cache-busting version applied`);
  assert(js.includes(runtime), `${feature.name}: v124-life-maps-final-ui-qa runtime version applied`);
