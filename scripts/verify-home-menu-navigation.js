...
for (const file of fs.readdirSync(path.join(root, 'tools')).filter((name) => name.endsWith('.html'))) {
  ...
  if (html.includes('/assets/js/app.js')) {
    assert(html.includes('/assets/js/app.js?v=20260623-v130-ev106-life-map-mobile-fix'), `${file} uses v130-ev106-life-map-mobile-fix app.js`);
  }
}
assert(index.includes('/assets/js/app.js?v=20260623-v130-ev106-life-map-mobile-fix'), 'index uses v130-ev106-life-map-mobile-fix app.js');
