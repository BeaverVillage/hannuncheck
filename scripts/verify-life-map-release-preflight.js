...
for (const tool of tools) {
  ...
  assert(html.includes(VERSION), `${tool.name}: html cache-busting query is v131-ev106-emergency-mobile-life-ui`);
  assert(js.includes(`const VERSION = '${RUNTIME}'`), `${tool.name}: runtime version is v131-ev106-emergency-mobile-life-ui`);
