...
for (const file of fs.readdirSync(path.join(root, 'tools')).filter((name) => name.endsWith('.html'))) {
  ...
  if (html.includes('/assets/js/app.js')) {
    assert(html.includes('/assets/js/app.js?v=20260623-v131-ev106-emergency-mobile-life-ui'), `${file} uses v131-ev106-emergency-mobile-life-ui app.js`);
  }
}
assert(index.includes('/assets/js/app.js?v=20260623-v131-ev106-emergency-mobile-life-ui'), 'index uses v131-ev106-emergency-mobile-life-ui app.js');
