...
for (const file of fs.readdirSync(path.join(root, 'tools')).filter((name) => name.endsWith('.html'))) {
  ...
  if (html.includes('/assets/js/app.js')) {
    assert(html.includes('/assets/js/app.js?v=20260623-v124-life-maps-final-ui-qa'), `${file} uses v124-life-maps-final-ui-qa app.js`);
  }
}
assert(index.includes('/assets/js/app.js?v=20260623-v124-life-maps-final-ui-qa'), 'index uses v124-life-maps-final-ui-qa app.js');
