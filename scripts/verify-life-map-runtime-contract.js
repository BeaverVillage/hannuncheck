...
const SHARED_VERSION = '20260623-v131-ev106-emergency-mobile-life-ui';
const tools = [
  {
    name: '낚시터',
    ...
    runtimeVersion: 'v131-ev106-emergency-mobile-life-ui',
...
for (const tool of tools) {
  ...
  assert(html.includes(SHARED_VERSION), `${tool.name}: html asset query is v131-ev106-emergency-mobile-life-ui`);
  assert(js.includes(`const VERSION = '${tool.runtimeVersion}'`), `${tool.name}: js runtime version is v131-ev106-emergency-mobile-life-ui`);
