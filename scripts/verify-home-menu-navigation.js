...
for (const file of fs.readdirSync(path.join(root, 'tools')).filter((name) => name.endsWith('.html'))) {
  ...
  if (html.includes('/assets/js/app.js')) {
    assert(html.includes('/assets/js/app.js?v=20260623-v126-life-maps-ui-polish-final'), `${file} uses v126-life-maps-ui-polish-final app.js`);
  }
}
assert(index.includes('/assets/js/app.js?v=20260623-v126-life-maps-ui-polish-final'), 'index uses v126-life-maps-ui-polish-final app.js');
