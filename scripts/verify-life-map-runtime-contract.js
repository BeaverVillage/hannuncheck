...
const SHARED_VERSION = '20260623-v130-ev106-life-map-mobile-fix';
const tools = [
  {
    name: '낚시터',
    ...
    runtimeVersion: 'v130-ev106-life-map-mobile-fix',
...
for (const tool of tools) {
  ...
  assert(html.includes(SHARED_VERSION), `${tool.name}: html asset query is v130-ev106-life-map-mobile-fix`);
  assert(js.includes(`const VERSION = '${tool.runtimeVersion}'`), `${tool.name}: js runtime version is v130-ev106-life-map-mobile-fix`);
