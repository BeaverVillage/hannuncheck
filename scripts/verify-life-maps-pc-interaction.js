...
tools.forEach((tool) => {
  ...
  assert(html.includes('20260623-v125-life-maps-ui-complete'), `${tool.name}: v125-life-maps-ui-complete html cache busting applied`);
  assert(js.includes("const VERSION = 'v125-life-maps-ui-complete'"), `${tool.name}: v125-life-maps-ui-complete runtime version applied`);
