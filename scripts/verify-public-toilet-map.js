...
assert(html.includes('/assets/js/public-toilet-map.js?v=20260623-v119-life-maps-triple-stability'), 'html uses v119 public toilet js');
...
assert(js.includes("const VERSION = 'v119-life-maps-triple-stability'"), 'js uses v119 runtime version');
