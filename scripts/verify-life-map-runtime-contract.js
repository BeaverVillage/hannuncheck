...
const SHARED_VERSION = '20260623-v126-life-maps-ui-polish-final';
const tools = [
  {
    name: '낚시터',
    ...
    runtimeVersion: 'v126-life-maps-ui-polish-final',
...
for (const tool of tools) {
  ...
  assert(html.includes(SHARED_VERSION), `${tool.name}: html asset query is v126-life-maps-ui-polish-final`);
  assert(js.includes(`const VERSION = '${tool.runtimeVersion}'`), `${tool.name}: js runtime version is v126-life-maps-ui-polish-final`);
