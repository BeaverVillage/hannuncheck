...
for (const file of fs.readdirSync(path.join(root, 'tools')).filter((name) => name.endsWith('.html'))) {
  ...
  if (html.includes('/assets/js/app.js')) {
    assert(html.includes('/assets/js/app.js?v=20260623-v125-life-maps-ui-complete'), `${file} uses v125-life-maps-ui-complete app.js`);
  }
}
assert(index.includes('/assets/js/app.js?v=20260623-v125-life-maps-ui-complete'), 'index uses v125-life-maps-ui-complete app.js');
