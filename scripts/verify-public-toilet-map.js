...
assert(html.includes('/assets/js/public-toilet-map.js?v=20260623-v126-life-maps-ui-polish-final'), 'html uses v125 public toilet js');
...
assert(js.includes("const VERSION = 'v126-life-maps-ui-polish-final'"), 'js uses v125 runtime version');
